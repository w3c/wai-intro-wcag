...
*Note:* **WCAG2ICT** is still relevant for future version of WCAG 2. For example, WCAG 2.1 does not change the requirements of WCAG 2.0 that are addressed in WCAG2ICT; WCAG 2.1 adds additional requirements. W3C does not currently plan to update WCAG2ICT for future versions of WCAG 2.
