...
<span class="smalltext" style="font-style:italic">(More goals are in the blog post [WCAG 3.0 Background — How we got from Silver to the First Public Working Draft](https://www.@@) and in [Requirements for WCAG 3.0](https://www.@@).)</span>
...
{::nomarkdown}
{% include box.html type="start" h="4" title="Draft example:" class="simple aside" %}
{:/}
