...
This page introduces the [https://www.w3.org/TR/WCAG30 W3C Accessibility Guidelines (WCAG) 3.0 Working Draft]. It explains how WCAG 3 is related to WCAG 2.
...
## Overview: Goals, Similar, Different {#compare}
...
<span class=”smalltext” style=”font-style:italic”>(More goals are in the blog post: [https://@@ WCAG 3.0 Background — How we got from Silver to the First Public Working Draft] and [https://w3c.github.io/@@ Requirements for WCAG 3.0].)</span>
...
* And specific questions in [WCAG 3.0 FPWD Review Questions](@@).

It will take some time to understand the proposed new structure and conformance model for WCAG 3.
* If you are interested in helping shape WCAG 3, we encourage you to spend time on this draft.
* If you don’t want to spend time learning WCAG 3 until it is more polished and stable, you can wait for later drafts in 2021.

@@? move - scope@@ Later drafts of WCAG 3 will have most of the accessibility requirements (“success criteria”) from WCAG 2 and will have additional accessibility requirements, including some from <abbr title="Authoring Tool Accessibility Guidelines">[ATAG](https://www.w3.org/WAI/standards-guidelines/atag/)</abbr> and <abbr title="User Agent Accessibility Guidelines">[UAAG](https://www.w3.org/TR/UAAG20/)</abbr>.
...
* Outcomes can be rated, beyond just pass or fail. For example, ratings for the outcome "Rating for ‘Conveys hierarchy with semantic structure’":

<table class=" dense quiet smalltext rating-table" summary="Rating scale for &quot;Conveys hierarchy with semantic structure&quot;">
  <thead>
    <tr>
