...
This page introduces the [W3C Accessibility Guidelines (WCAG) 3.0 Working Draft](https://www.w3.org/TR/WCAG30). It explains how WCAG 3 is related to WCAG 2.<br>This page is the starting point for information about WCAG 3.
...
### Background: How we got from Silver to the First Public Working Draft {#background}
