...
This page introduces the [W3C Accessibility Guidelines (WCAG) 3.0 Working Draft](https://www.w3.org/TR/WCAG30). It explains how WCAG 3 is related to WCAG 2. It helps you get started learning all about WCAG 3.
...
The WCAG documents explain how to make web content, apps, and tools more accessible to people with disabilities. _(The rest of this page uses “website” for simplicity, yet WCAG applies more broadly than websites.)_
...
This page will be updated with additional information. For example, in the future it could link to mapping between WCAG 2 and 3 and to other support for those wanting to transition from 2 to 3.
...
* If you want to wait until WCAG 3 is more polished and stable to start learning it, you can read later drafts in 2021 and 2022.
...
_Reminder that WCAG 3 applies to web content, apps, tools, documents, and other such digital technology. Most of this page uses “website” for simplicity._
